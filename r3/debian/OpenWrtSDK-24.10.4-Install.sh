...
#   curl -sL https://raw.githubusercontent.com/nipegun/bpi-scripts/refs/heads/main/r3/debian/OpenWrtSDK-24.10.4-Install.sh | bash
# ----------
...
# Crear la carpeta
  mkdir -p $HOME/OpenWrtSDK/bpi-r3/24.10.4/
  cd $HOME/OpenWrtSDK/bpi-r3/24.10.4/
